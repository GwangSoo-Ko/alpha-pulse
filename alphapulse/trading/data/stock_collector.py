"""주가 수집기 -- 네이버 금융 스크래핑 기반.

KRX API 로그인 요구로 인해 네이버 금융(finance.naver.com)에서
종목별 일별 시세(OHLCV)를 스크래핑한다.
"""
...
class StockCollector:
    ...
    def collect_ohlcv(self, code: str, start: str, end: str) -> None:
        ...
        rows = []
        page = 1
        max_pages = 100  # 안전 제한 (1페이지=10일, 100페이지=약4년)
